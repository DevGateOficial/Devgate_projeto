...
class CarregarPgAdm
{
    ...
    {
        $this->listPgPublica = ["Erro", "Logout", "CadastroUser", "CadastroCurso", "Dashboard", "ListCursos", "ConfEmail", "RecoverPass", "UpdatePass", "CadastroAula", "ListAulas", "CadastroAtividade"];
